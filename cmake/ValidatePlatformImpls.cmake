...
string(REGEX MATCHALL "\n(void|bool)[ \t]+[A-Za-z_][A-Za-z0-9_]*[ \t]*\\(" declarations "${header_contents}")

set(function_names)
foreach(declaration IN LISTS declarations)
    string(REGEX REPLACE ".*(void|bool)[ \t]+([A-Za-z_][A-Za-z0-9_]*)[ \t]*\\(.*" "\\2" function_name "${declaration}")
